...
import * as TableComponents from '@redallen-patternfly/react-table';
import * as ChartComponents from '@redallen-patternfly/react-charts';
import * as CoreComponents from '@redallen-patternfly/react-core';
import * as CoreIcons from '@redallen-patternfly/react-icons';
import * as StyledSystemComponents from '@redallen-patternfly/react-styled-system';
...
class LiveDemo extends React.Component {
  ...
  render() {
    ...
    const GITHUB_BASE = 'https://github.com/redallen/patternfly-react/blob/master/packages';
